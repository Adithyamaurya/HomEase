...
if (isset($_POST['change_password'])) {
    ...
    if (password_verify($current_password, $row['password'])) {
        if ($new_password === $confirm_password) {
            ...
            mysqli_query($conn, "UPDATE users SET password='$new_hashed' WHERE user_id='$user_id'");
...
<head>
    <meta charset="UTF-8">
    <title>Manage Profile | HomEase User</title>
...
<header class="navbar">
    <div class="navbar-content">
        ...
        <div class="navbar-right">
            ...
            <a href="login.php?logout=true" class="cta-btn">Logout</a>
        </div>
    </div>
</header>
